...
phrases_to_replace = read_mapping_from_csv(
    "words_to_replace.csv",
    expectedHeaders=("Replacement", "Original")
)
...
ctx.lists["user.vocabulary"] = read_mapping_from_csv(
    "additional_words.csv",
    expectedHeaders=("Word(s)", "Spoken Form (If Different)")
)
