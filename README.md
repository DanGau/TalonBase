This Repository is intended to reside within the user directory of a talon install. Talon will follow a junction point from talon user folder to another location on the same volume if that's preferred.
